...
import { User, MapPin, BookOpen, ExternalLink } from "lucide-react";
        ...
        <table className="w-full text-sm text-left border-collapse min-w-[650px]">
          <thead>
            <tr className="border-b border-border/80 bg-muted/40 text-xs font-semibold text-muted-foreground">
              ...
              <th scope="col" className="py-3 px-3 text-center w-[110px]">
                L-T-P-C / Type
              </th>
              <th scope="col" className="py-3 px-4">
                Faculty
              ...
              return (
                ...
                >
                  <td className="py-3.5 px-4 font-mono font-semibold">
                    <span className="inline-block px-2.5 py-1 rounded bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 text-xs tracking-tight">
                      {item.code}
                    </span>
                  </td>
                  ...
                  <td className="py-3.5 px-3 text-center text-xs text-muted-foreground font-mono">
                    {item.isLab ? (
