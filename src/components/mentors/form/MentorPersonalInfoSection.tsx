...
interface MentorPersonalInfoSectionProps {
  formData: MentorFormData;
  handleChange: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void;
}

const MentorPersonalInfoSection = ({ formData, handleChange }: MentorPersonalInfoSectionProps) => {
  return (
...
export default MentorPersonalInfoSection;
