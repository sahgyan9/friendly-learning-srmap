...
/**
 * Traced from public/lovable-uploads/female-teacher.svg — same artwork, same
 * path data, just `fill="currentColor"` in place of the hardcoded black so it
 * recolors with the accent and switches for light/dark like every other nav
 * icon.
 */
export const FacultyIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({
  className = "h-5 w-5",
  ...props
}) => {
  return (
    <svg
      viewBox="0 0 957.614 957.614"
      fill="currentColor"
      className={className}
      {...props}
    >
