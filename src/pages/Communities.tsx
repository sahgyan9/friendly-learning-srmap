...
import MyInvites from "@/components/workspace-groups/MyInvites";
import { MyCommunitiesHub } from "@/components/workspace-groups/MyCommunitiesHub";
import { CommunityDiscoveryView } from "@/components/workspace-groups/CommunityDiscoveryView";
import { CommunityOnboardingHero } from "@/components/workspace-groups/CommunityOnboardingHero";
...
const Communities = () => {
  ...
  const fetchCommunities = useCallback(
    () => listCommunities({ search: debouncedSearch, kind, limit: 60 }),
    [debouncedSearch, kind],
  );
  const {
    items: allCommunities,
    setItems: setAllCommunities,
    loading,
  } = useOfflineCachedList<Community>({
    cacheKey: "workspace_communities_list",
    fetcher: fetchCommunities,
