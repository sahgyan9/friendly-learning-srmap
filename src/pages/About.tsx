...
const About = () => {
  const structuredData = {
    ...
    "description": "Learn about Project FL, the university student collaboration platform for finding study partners, hackathon teams, and project collaborators",
    "mainEntity": {
      "@type": "Organization",
      "name": "Project FL",
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <section className="mb-8">
                <p className="text-lg mb-6">
                  <strong>Project FL (Friendly Learning)</strong> is a university student collaboration platform that connects students within the same university for various academic and project-based needs. Whether you need academic help, looking for hackathon partners, seeking project collaborators, or want to find like-minded peers for startups - Project FL brings the university community together.
                </p>
                <p className="text-lg mb-6">
                  Our platform eliminates the traditional barriers of finding the right people within your university. Instead of wondering who might have the skills you need or share your interests, Project FL helps you discover and connect with fellow students who can help you succeed.
                </p>
                <p className="text-lg mb-6">
              ...
              <section className="text-center mb-8">
                ...
                <p className="text-lg mb-6">
                  Join Project FL today and discover the power of student collaboration within your university. Whether you need help, want to help others, or looking for project partners - your university community is here for you.
                </p>
