...
- **Next agent should**:
  - Apply `20260914120000` via the SQL editor, confirm `embed-knowledge-topup` reads Vault, then deploy embed-knowledge (the literal is still accepted until then); delete the `LOVABLE_API_KEY` secret.
