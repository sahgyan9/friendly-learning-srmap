...
function renderWelcomeMentorEmail(opts: {
  ...
  const html = [
    ...
    `<td style="vertical-align:middle;padding-right:8px;"><img src="${SITE_URL}/brand/logo-email.png" width="40" height="26" alt="Friendly Learning" style="display:block;border:0;"></td>`,
    ...
    `<tr><td style="padding:4px 0;"><a href="${SITE_URL}/attendance" style="font-size:13px;color:#3963c6;text-decoration:none;font-weight:500;">Link SRM Portal once</a><span style="font-size:13px;color:#94a3b8;margin-left:6px;">— auto-sync daily attendance & timetable</span></td></tr>`,
    `<tr><td style="padding:4px 0;"><a href="${SITE_URL}/search" style="font-size:13px;color:#3963c6;text-decoration:none;font-weight:500;">CampusBrain AI</a><span style="font-size:13px;color:#94a3b8;margin-left:6px;">— SRM AP syllabus & regulations answers</span></td></tr>`,
    `<tr><td style="padding:4px 0;"><a href="${SITE_URL}/events" style="font-size:13px;color:#3963c6;text-decoration:none;font-weight:500;">Events & activities</a><span style="font-size:13px;color:#94a3b8;margin-left:6px;">— see who's attending & team up</span></td></tr>`,
    `<tr><td style="padding:4px 0;"><a href="${SITE_URL}/find-study-partners" style="font-size:13px;color:#3963c6;text-decoration:none;font-weight:500;">Find study partners</a><span style="font-size:13px;color:#94a3b8;margin-left:6px;">— never prep for exams alone</span></td></tr>`,
    `<tr><td style="padding:4px 0;"><a href="${SITE_URL}/hackathon-partners" style="font-size:13px;color:#3963c6;text-decoration:none;font-weight:500;">Hackathon teammates</a><span style="font-size:13px;color:#94a3b8;margin-left:6px;">— build something real</span></td></tr>`,
    `<tr><td style="padding:4px 0;"><a href="${SITE_URL}/faculty" style="font-size:13px;color:#3963c6;text-decoration:none;font-weight:500;">Faculty search & ratings</a><span style="font-size:13px;color:#94a3b8;margin-left:6px;">— discover research & anonymous reviews</span></td></tr>`,
    "</table></div>",
